...
Protected Module Strings
	...
	#tag Constant, Name = ChoosePDF, Type = String, Dynamic = True, Default = \"Choose PDF-File(s)", Scope = Protected
		#Tag Instance, Platform = Any, Language = en, Definition  = \"Choose PDF-File(s)"
		#Tag Instance, Platform = Any, Language = de, Definition  = \"PDF-Datei(en) ausw\xC3\xA4hlen"
	#tag EndConstant

	#tag Constant, Name = Close, Type = String, Dynamic = True, Default = \"Close", Scope = Protected
		#Tag Instance, Platform = Any, Language = en, Definition  = \"Close"
		#Tag Instance, Platform = Any, Language = de, Definition  = \"Schlie\xC3\x9Fen"
	#tag EndConstant

	#tag Constant, Name = Content, Type = String, Dynamic = True, Default = \"Content", Scope = Protected
		#Tag Instance, Platform = Any, Language = en, Definition  = \"Content"
		#Tag Instance, Platform = Any, Language = de, Definition  = \"Inhalt"
	#tag EndConstant

	#tag Constant, Name = Created, Type = String, Dynamic = True, Default = \"Created", Scope = Protected
		#Tag Instance, Platform = Any, Language = en, Definition  = \"Created"
	...
	#tag Constant, Name = Filename, Type = String, Dynamic = True, Default = \"Filename", Scope = Protected
		#Tag Instance, Platform = Any, Language = en, Definition  = \"Filename"
		#Tag Instance, Platform = Any, Language = de, Definition  = \"Dateiname"
	#tag EndConstant
	...
	#tag Constant, Name = Modified, Type = String, Dynamic = True, Default = \"Modified", Scope = Protected
		#Tag Instance, Platform = Any, Language = en, Definition  = \"Modified"
		#Tag Instance, Platform = Any, Language = de, Definition  = \"Ge\xC3\xA4ndert"
	#tag EndConstant

	#tag Constant, Name = Print, Type = String, Dynamic = True, Default = \"Print", Scope = Protected
	...
	#tag Constant, Name = Type, Type = String, Dynamic = True, Default = \"Type", Scope = Protected
